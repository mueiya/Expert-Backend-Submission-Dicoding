...
const ViewDetaiThreadByIdUseCase = require('../Applications/use_case/ViewDetailThreadByIdUseCase');
...
container.register([
  ...
  {
    key: ViewDetaiThreadByIdUseCase.name,
    Class: ViewDetaiThreadByIdUseCase,
    parameter: {
      injectType: 'destructuring',
      dependencies: [
        {
